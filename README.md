...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8iq6gyc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8iq6gyc.containers.anotherwebservice.com/
...
```
git clone git@github.com:Daeky03/container-8iq6gyc.git
cd container-8iq6gyc
```
...
```
docker attach container-8iq6gyc
```
